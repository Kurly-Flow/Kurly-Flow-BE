...
public interface WorkerRepository extends JpaRepository<Worker, Long> {
  ...
  //미배정받았고,출석은 한 작업자
  @Query("SELECT w FROM Worker w WHERE w.region = com.detailretail.kurlyflow.common.vo.Region.UNASSIGNED AND w.isAttended = true AND w.loginAt > :beforeOneHour AND w.admin.id is null")
