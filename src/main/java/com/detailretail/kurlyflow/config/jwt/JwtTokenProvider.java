...
public class JwtTokenProvider {
  ...
  public String createToken(String userPk, List<String> roles) {
    ...
    System.out.println("roles.get(0) = " + roles.get(0));
    Date now = new Date();
  ...
  public Authentication getAuthentication(String token) {
    System.out.println("getAuthentication::"+this.getUserPk(token));
    UserDetails userDetails = workerDetailService.loadUserByUsername(this.getUserPk(token));
